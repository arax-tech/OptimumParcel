                    ...
                    <div class="card" style="height: 375px">
                        <div class="card-body">
                            <div class="text-center mt-3">
                                ...
                                <img src="{{ asset('backend/admin/profile/'.auth::user()->image) }}" class="avatar-lg rounded-circle">
                                @else
                                <img src="{{ asset('placeholder.jpg') }}" class="avatar-lg rounded-circle">
                                @endif
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{ url('admin/profile') }}">
                                        @csrf
